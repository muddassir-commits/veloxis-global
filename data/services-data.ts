...
export const servicesData: ServiceData[] = [
  {
    ...
    "definition": "Performance marketing is a data-driven digital advertising strategy where advertisers pay only for measurable results like clicks, leads, or sales.",
  ...
  },
  {
    ...
    "definition": "Search Engine Optimization is the process of optimizing a website to rank on the first page of search engine results for target search terms.",
  ...
  },
  {
    ...
    "definition": "Content marketing is a strategic marketing approach focused on creating and distributing valuable, relevant, and consistent content to attract and acquire a clearly defined audience.",
  ...
  },
  {
    ...
    "definition": "Social media marketing is the process of creating content and running ads on platforms like Instagram, Facebook, and LinkedIn to build brand authority and generate leads.",
  ...
  },
  {
    ...
    "definition": "Web design and development is the process of building fast, responsive, and search-optimized websites that turn visitors into customers.",
  ...
  },
  {
    ...
    "definition": "Email and WhatsApp marketing is the practice of using automated messages, sequences, and newsletters to nurture leads, drive conversions, and re-engage customers.",
  ...
  },
  {
    ...
    "definition": "AI and marketing automation is the integration of intelligent software tools and automated workflows to streamline operations and nurture client pipelines.",
  ...
  },
  {
    ...
    "definition": "Brand strategy and positioning is the process of defining a business's identity, visual design systems, and market-facing value propositions to stand out from competitors.",
  ...
  },
  {
    ...
    "definition": "Marketing analytics and tracking is the practice of setting up measurement parameters like GA4 and Conversions API to attribute sales to specific traffic channels.",
  ...
  },
  {
    ...
    "definition": "Digital marketing training is the delivery of hands-on bootcamps, workshops, and manuals to educate teams on SEO, paid search, and automation systems.",
  ...
  },
  {
    ...
    "definition": "E-commerce catalog services is the optimization of product detail listings, A+ content, and inventory syncing on platforms like Shopify and Amazon.",
  ...
  },
  {
    ...
    "definition": "Digital marketing audits and consulting is the manual diagnostic review of a website's speed, keyword gaps, and ad performance to map out a custom growth roadmap.",
  ...
  },
  {
    ...
    "definition": "B2B lead generation is the process of building verified contact lists, setting up cold email channels, and using LinkedIn to schedule sales consultations.",
  ...
  },
  {
    ...
    "definition": "Industry-specific marketing is the creation of tailored acquisition campaigns designed specifically for high-growth sectors like real estate, EdTech, healthcare, and SaaS.",
