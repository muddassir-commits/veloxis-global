...
export const metadata: Metadata = constructMetadata({
  title: "Gym & Fitness Studio Marketing Agency | Veloxis Global",
  description: "Grow gym memberships, yoga studio sign-ups, and personal trainer inquiries. Hyper-local maps SEO and WhatsApp booking automations.",
  path: "/industries/fitness-wellness"
});

export default function FitnessWellnessIndustryPage() {
  const industry = getIndustryBySlug('fitness-wellness');
  if (!industry) {
    notFound();
  }
