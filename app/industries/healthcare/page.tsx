...
export const metadata: Metadata = constructMetadata({
  title: "Healthcare & Clinic Patient Acquisition Agency | Veloxis Global",
  description: "Grow doctor appointments and clinic visits with local maps SEO, Google Search campaigns, and automated WhatsApp follow-up structures.",
