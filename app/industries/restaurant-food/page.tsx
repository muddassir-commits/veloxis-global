...
export const metadata: Metadata = constructMetadata({
  title: "Restaurant & Cloud Kitchen Marketing Agency | Veloxis Global",
  description: "Lower third-party app commissions and grow direct-to-consumer food orders. We optimize local SEO map rankings and drive store traffic.",
  path: "/industries/restaurant-food"
});

export default function RestaurantFoodIndustryPage() {
  const industry = getIndustryBySlug('restaurant-food');
  if (!industry) {
    notFound();
  }
