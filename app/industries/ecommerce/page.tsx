...
export const metadata: Metadata = constructMetadata({
  title: "D2C E-commerce Growth & Marketing Agency | Veloxis Global",
  description: "Scale Shopify and WooCommerce online store sales. We optimize Meta catalog ads, Google Performance Max campaigns, and Klaviyo email flows.",
