...
export const metadata: Metadata = constructMetadata({
  title: "MSME & Local Business Marketing Agency | Veloxis Global",
  description: "Scale local customer inquiries, Google Maps phone calls, and inbound website leads for MSMEs and local service providers.",
  path: "/industries/msme-small-business"
});

export default function MsmeSmallBusinessIndustryPage() {
  const industry = getIndustryBySlug('msme-small-business');
  if (!industry) {
    notFound();
  }
