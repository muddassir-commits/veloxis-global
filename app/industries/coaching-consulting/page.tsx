...
export const metadata: Metadata = constructMetadata({
  title: "Marketing Agency for Coaches & Consultants | Veloxis Global",
  description: "Get more high-ticket clients with automated VSL sales funnels, paid social campaigns, and authority-building personal brand strategies.",
  path: "/industries/coaching-consulting"
});

export default function CoachingConsultingIndustryPage() {
  const industry = getIndustryBySlug('coaching-consulting');
  if (!industry) {
    notFound();
  }
