...
export const metadata: Metadata = constructMetadata({
  title: "NGO & Non-Profit Marketing Agency | Veloxis Global",
  description: "Apply for the $10,000/month free Google Ad Grant and optimize online donor acquisition campaigns. View our NGO cases.",
  path: "/industries/non-profit"
});

export default function NonProfitIndustryPage() {
  const industry = getIndustryBySlug('non-profit');
  if (!industry) {
    notFound();
  }
