...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages = [
    ...
    { url: `${BASE}/services/paid-ads-performance-marketing`, priority: 0.80, changeFrequency: 'weekly' as const },
    { url: `${BASE}/services/b2b-lead-generation`, priority: 0.80, changeFrequency: 'weekly' as const },
    { url: `${BASE}/services/ai-marketing-automation`, priority: 0.80, changeFrequency: 'weekly' as const },
    { url: `${BASE}/services/brand-strategy`, priority: 0.80, changeFrequency: 'weekly' as const },
    { url: `${BASE}/services/analytics-tracking`, priority: 0.80, changeFrequency: 'weekly' as const },
    { url: `${BASE}/services/audits-consulting`, priority: 0.80, changeFrequency: 'weekly' as const },
    { url: `${BASE}/services/ecommerce-services`, priority: 0.80, changeFrequency: 'weekly' as const },
    { url: `${BASE}/services/training-education`, priority: 0.80, changeFrequency: 'weekly' as const },
