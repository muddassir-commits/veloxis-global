    ...
    >
      <div className="max-w-container-max mx-auto px-gutter">
        ...
        <Card hoverable={false} className="bg-primary-container border border-white/10 rounded-2xl p-6 sm:p-10 text-left relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(#ffffff_1px,transparent_1px)] bg-[size:24px_24px] opacity-[0.03]"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            ...
            <div className="lg:col-span-7 flex flex-col items-start gap-5">
              ...
              {/* Staggered Metric Chips on Scroll */}
              <motion.div 
                {...getStaggerContainer(0.15)}
                className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full my-4"
              >
                <motion.div 
                  {...getStaggerChild()} 
                  className="bg-teal-accent/20 border border-teal-accent/30 rounded-lg px-4 py-3 flex flex-col items-start"
                >
                ...
                <motion.div 
                  {...getStaggerChild()}
                  className="bg-sunset-orange/20 border border-sunset-orange/30 rounded-lg px-4 py-3 flex flex-col items-start"
                >
                ...
                <motion.div 
                  {...getStaggerChild()}
                  className="bg-indigo-accent/20 border border-indigo-accent/30 rounded-lg px-4 py-3 flex flex-col items-start"
                >
            ...
            <div className="lg:col-span-5 relative w-full h-[320px] bg-slate-900/50 border border-white/5 rounded-xl flex items-center justify-center p-6 overflow-hidden">
              {/* SVG Google Search Console steep curve */}
